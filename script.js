...
var pterodactylAnimation = null;

function calculerEquation() 
{

  if (pterodactylAnimation != null)
  {
    pterodactylAnimation.destroy();
    pterodactylAnimation = null;
  }
    ...
    if(a === 0)
    {
      ...
      pterodactylAnimation = new PterodactylAnimation("pterodactyle", ['images/1.png', 'images/2.png', 'images/3.png', 'images/4.png', 'images/5.png', 'images/6.png'], normeSolution1);
